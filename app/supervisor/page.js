...
export default function SupervisorPage(){
  ...
  return <main className="shell"><div className="topbar"><a className="brand" href="/supervisor">MASTERCRAFT SUPERVISOR</a><div className="navlinks"><a className="navlink" href="#calendar">Calendar</a><a className="navlink" href="#records">Records</a><a className="navlink" href="/employee">My Work</a><button className="toplink" onClick={logout}>Sign out</button></div></div><div className="container">
